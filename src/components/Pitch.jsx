  ...
  useEffect(() => {
    const move = (e) => {
      ...
      if (didMove.current) {
        ...
        const x = Math.max(
          5,
          Math.min(95, ((pt.clientX - rect.left) / rect.width) * 100)
        );
        const y = Math.max(
          5,
          Math.min(95, ((pt.clientY - rect.top) / rect.height) * 100)
        );
    ...
    <div style={{ padding: '16px 24px 0' }}>
      ...
      >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      border: 'none',
                      background:
                        active && !isDisabled ? C.accent : 'transparent',
                      color:
                        active && !isDisabled
                          ? C.accentInk
                          : isDisabled
        ...
        {formation &&
          ...
          placedPlayers.length < FORMATIONS[formation].length &&
          (() => {
            ...
            >
              <div
                style={{
                  ...
                  boxShadow:
                    '0 0 0 3px rgba(220,38,38,0.3), 0 3px 10px rgba(0,0,0,0.5)',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  fontWeight: 700,
              ...
              <div style={{ position: 'relative' }}>
                <div
                  style={{
                    ...
                    fontWeight: 700,
                    fontSize:
                      ((p.label || info.number) + '').length > 2 ? 11 : 14,
                    color: '#fff',
                  }}
                >
                  {p.label || info.number}
      ...
      {editingPlayerId &&
        (() => {
          const target = placedPlayers.find(
            (p) => p.playerId === editingPlayerId
          );
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <p
          style={{ margin: 0, marginBottom: 20, fontSize: 11, color: C.muted }}
        >
